...
export default function ExploreMobile1({ setActiveTab }) {
      ...
      >
        <Grid item xs={8}>
          <TabContext value={1}>
            ...
            >
                <AntTab label="People" style={{ width: "150px" }} onClick={()=>setActiveTab(2)}/>
